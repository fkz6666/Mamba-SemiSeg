...
#from triton_config_stub import Config
...
heuristics({"HAS_X1": lambda args: args["X1"] is not None})
heuristics({"HAS_W1": lambda args: args["W1"] is not None})
heuristics({"HAS_B1": lambda args: args["B1"] is not None})
jit
...
heuristics({"HAS_ROWSCALE": lambda args: args["ROWSCALE"] is not None})
heuristics({"HAS_DY1": lambda args: args["DY1"] is not None})
heuristics({"HAS_DX1": lambda args: args["DX1"] is not None})
heuristics({"HAS_B1": lambda args: args["DB1"] is not None})
heuristics({"RECOMPUTE_OUTPUT": lambda args: args["Y"] is not None})
jit
