...
heuristics({"HAS_DT_BIAS": lambda args: args["dt_bias_ptr"] is not None})
heuristics({"HAS_D": lambda args: args["D_ptr"] is not None})
heuristics({"HAS_Z": lambda args: args["z_ptr"] is not None})
heuristics({"HAS_STATE_BATCH_INDICES": lambda args: args["state_batch_indices_ptr"] is not None})
heuristics({"BLOCK_SIZE_DSTATE": lambda args: triton.next_power_of_2(args["dstate"])})
jit
